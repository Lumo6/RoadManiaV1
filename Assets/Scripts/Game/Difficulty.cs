...
public class Difficulty : ScriptableObject
{
    ...
    [Tooltip("Pourcentage d'augmentation de la probabilité d'apparition des obstacles")]
    ...
    [SerializeField]
    [Tooltip("Paramétre en secondes (utilisé si Temps est sélectionné).")]
    public float toutesLesNbSecondes;

    [SerializeField]
    [Tooltip("Paramétre en métres (utilisé si Distance est sélectionné).")]
